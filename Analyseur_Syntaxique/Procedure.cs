...
namespace Analyseur_Syntaxique
{
    class Procedure
    {
        ...
        {
            string temp = "";
            if (proc.Contains("Procedure") && proc.Contains("Fin_Procedure"))
            {
            ...
            {
                Console.WriteLine("Erreur: Il manque 'Procedure' au début de la procédure ou 'Fin_Procedure à la fin d'icelle.");
                Environment.Exit(0);
            }
        }
